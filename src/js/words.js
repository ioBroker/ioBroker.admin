...
systemDictionary = {
    ...
    "cert_path_note": {
        "en": "you can use absolute path to certificate, like '/opt/certs/cert.pem', or just upload it per drag&drop",
        "de": "Sie können den absoluten Pfad zum Zertifikat verwenden, wie '/opt/certs/cert.pem', oder einfach hochladen",
        "ru": "вы можете использовать абсолютный путь к сертификату, например '/opt/certs/cert.pem', или просто перетащить файл сюда"
    },
