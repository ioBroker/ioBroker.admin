...
function Socket (ws, sessionID, name) {
    ...
    this.responseWithCallback = (name, id, arg1, arg2, arg3, arg4, arg5) => {
        let args;
        if (arg1 === undefined && arg2 === undefined && arg3 === undefined && arg4 === undefined && arg5 === undefined) {
            return ws.send(JSON.stringify([MESSAGE_TYPES.CALLBACK, name, id]));
        } else if (arg2 === undefined && arg3 === undefined && arg4 === undefined && arg5 === undefined) {
            args = [arg1];
        } else if (arg3 === undefined && arg4 === undefined && arg5 === undefined) {
            args = [arg1, arg2];
    ...
    this.withCallback = (name, id, args) => {
        if (!args || !args.length) {
            setImmediate(() =>
                handlers[name].forEach(cb => cb.call(this, (arg1, arg2, arg3, arg4, arg5) =>
                    this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5))));
        } else if (args.length === 1) {
            setImmediate(() =>
                handlers[name].forEach(cb => cb.call(this, args[0], (arg1, arg2, arg3, arg4, arg5) =>
                    this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5))));
        } else if (args.length === 2) {
            setImmediate(() =>
                handlers[name].forEach(cb => cb.call(this, args[0], args[1], (arg1, arg2, arg3, arg4, arg5) =>
                    this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5))));
        } else if (args.length === 3) {
            setImmediate(() =>
                handlers[name].forEach(cb => cb.call(this, args[0], args[1], args[2], (arg1, arg2, arg3, arg4, arg5) =>
                    this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5))));
        } else if (args.length === 4) {
            setImmediate(() =>
                handlers[name].forEach(cb => cb.call(this, args[0], args[1], args[2], args[3], (arg1, arg2, arg3, arg4, arg5) =>
                    this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5))));
        } else {
            setImmediate(() =>
                handlers[name].forEach(cb => cb.call(this, args[0], args[1], args[2], args[3], args[4], (arg1, arg2, arg3, arg4, arg5) =>
                    this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5))));
        }
    };
    ...
    ws.on('message', message => {
        ...
        if (type === MESSAGE_TYPES.MESSAGE) {
            DEBUG && console.log(name);
            handlers[name] && setImmediate(() => handlers[name].forEach(cb => cb.call(this, args[0], args[1], args[2], args[3], args[4])));
    ...
    wss.on('connection', (ws, request) => {
        ...
        if (request._wsNotAuth) {
            ...
            if (query && query.sid) {
                ...
                // install handlers
                handlers.connection && handlers.connection.forEach(cb => cb(socket));
