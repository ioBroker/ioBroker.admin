        ...
        if (!args || !args.length) {
            setImmediate(
                () =>
                    ...
                    handlers[name].forEach(cb =>
                        cb.call(this, (arg1, arg2, arg3, arg4, arg5) =>
                            this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5)
                        )
                    )
            );
            ...
            setImmediate(
                () =>
                    handlers[name] &&
                    handlers[name].forEach(cb =>
                        cb.call(this, args[0], (arg1, arg2, arg3, arg4, arg5) =>
                            this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5)
                        )
                    )
            );
            ...
            setImmediate(
                () =>
                    handlers[name] &&
                    handlers[name].forEach(cb =>
                        cb.call(this, args[0], args[1], (arg1, arg2, arg3, arg4, arg5) =>
                            this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5)
                        )
                    )
            );
            ...
            setImmediate(
                () =>
                    handlers[name] &&
                    handlers[name].forEach(cb =>
                        cb.call(this, args[0], args[1], args[2], (arg1, arg2, arg3, arg4, arg5) =>
                            this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5)
                        )
                    )
            );
            ...
            setImmediate(
                () =>
                    handlers[name] &&
                    handlers[name].forEach(cb =>
                        cb.call(this, args[0], args[1], args[2], args[3], (arg1, arg2, arg3, arg4, arg5) =>
                            this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5)
                        )
                    )
            );
            ...
            setImmediate(
                () =>
                    handlers[name] &&
                    handlers[name].forEach(cb =>
                        cb.call(this, args[0], args[1], args[2], args[3], args[4], (arg1, arg2, arg3, arg4, arg5) =>
                            this.responseWithCallback(name, id, arg1, arg2, arg3, arg4, arg5)
                        )
                    )
            );
        ...
        if (type === MESSAGE_TYPES.CALLBACK) {
            ...
            handlers[name] &&
                setImmediate(
                    () =>
                        handlers[name] &&
                        handlers[name].forEach(cb => cb.call(this, args[0], args[1], args[2], args[3], args[4]))
                );
...
function SocketIO(server) {
    ...
    wss.on('connection', (ws, request) => {
        ...
        if (request && request._wsNotAuth) {
            ...
            setTimeout(() => ws && ws.destroy && ws.destroy(), 500);
        } else {
            let query;
            ...
            if (query && query.sid) {
                ...
                if (handlers.connection && handlers.connection.length) {
                    ...
                    handlers.connection.forEach(cb =>
                        cb(socket, () => {
                            if (timeout) {
    ...
    this.sockets = {
        ...
        emit: (arg1, arg2, arg3, arg4, arg5) =>
            socketsList.forEach(socket => socket.emit(arg1, arg2, arg3, arg4, arg5)),
        engine: {
            clientsCount: 0,
        },
    };
