            ...
            for (var i = 0; i < names.length; i++) {
                ...
                if (names[i]) {
                    ...
                    if (names[i].name === '_index') {
                        ...
                        line +=
                            '<input style="' +
                            (names[i].style || '') +
                            '" class="values-input" type="checkbox" data-index="' +
                            v +
                            '" data-name="' +
                            names[i].name +
                            '" ' +
                ...
                if (buttons[i]) {
                    ...
                    for (var b = 0; b < buttons[i].btn.length; b++) {
                        if (
                            (!v && buttons[i].btn[b] === 'up') ||
                            (v === values.length - 1 && buttons[i].btn[b] === 'down')
                        ) {
                            line +=
                                '<a class="btn-floating disabled" data-command="' +
                                buttons[i].btn[b] +
                                '" class="values-buttons"><i class="material-icons"></i></a>';
                            continue;
                        }
                        line +=
                            '<a class="btn-floating" data-index="' +
                            v +
                            '" data-command="' +
                            buttons[i].btn[b] +
                            '" class="values-buttons"><i class="material-icons"></i></a>';
