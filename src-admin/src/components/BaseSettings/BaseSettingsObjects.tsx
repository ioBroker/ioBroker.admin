...
import { DialogConfirm, type IobTheme, type Translate } from '@iobroker/gui-components';
...
export default class BaseSettingsObjects extends Component<BaseSettingsObjectsProps, BaseSettingsObjectsState> {
    ...
    constructor(props: BaseSettingsObjectsProps) {
        ...
        this.state = {
            ...
            textIP: BaseSettingsObjects.calculateTextIP(
    ...
    componentDidMount(): void {
        void this.props.socket.getIpAddresses(this.props.currentHost).then(_IPs => {
            ...
            const textIP = BaseSettingsObjects.calculateTextIP(this.state.host, IPs);
            this.setState(
    ...
    componentDidUpdate(prevProps: BaseSettingsObjectsProps): void {
    ...
    render(): JSX.Element {
        return (
            <Paper style={styles.paper}>
                ...
                {this.renderWarning()}
                <Grid style={{ ...styles.gridSettings, ...styles.dangerZone }}>
                    <h3
