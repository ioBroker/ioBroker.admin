...
class ConfigTextSendTo extends ConfigGeneric {
    ...
    renderItem( /* error, disabled, defaultValue */) {
        ...
        if (this.props.schema.container === 'text') {
            return React.createElement(TextField, { variant: "standard", fullWidth: true, InputProps: {
        ...
        return React.createElement("div", { className: this.props.classes.fullWidth }, this.state.text);
    }
}
