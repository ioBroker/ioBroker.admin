...
class ConfigFile extends ConfigGeneric {
    ...
    renderFileBrowser() {
        ...
        return React.createElement(SelectFileDialog, { imagePrefix: this.props.imagePrefix, socket: this.props.socket, selected: this.state.value, onClose: () => this.setState({ showFileBrowser: false }), onOk: value => {
                this.setState({ value }, () => this.onChange(this.props.attr, this.props.schema.trim === false ? value : (value || '').trim()));
            }, selectOnlyFolders: this.props.schema.selectOnlyFolders, allowUpload: this.props.schema.allowUpload, allowDownload: this.props.schema.allowDownload, allowCreateFolder: this.props.schema.allowCreateFolder, allowView: this.props.schema.allowView, showToolbar: this.props.schema.showToolbar, limitPath: this.props.schema.limitPath });
    }
    renderItem(error, disabled /* , defaultValue */) {
        const icon = this.getIcon();
        return React.createElement("div", { className: this.props.classes.fullWidth },
            icon,
            React.createElement(TextField, { variant: "standard", className: icon ? this.props.classes.fullWidthIcon : this.props.classes.fullWidthOneButton, value: this.state.value === null || this.state.value === undefined ? '' : this.state.value, error: !!error, disabled: !!disabled, inputProps: {
            ...
            React.createElement(Button, { variant: "outlined", onClick: () => this.setState({ showFileBrowser: true }) }, "..."),
