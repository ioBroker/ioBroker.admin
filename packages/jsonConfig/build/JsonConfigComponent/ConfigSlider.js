...
class ConfigSlider extends ConfigGeneric {
    ...
    renderItem(error, disabled /* , defaultValue */) {
        ...
        return (React.createElement(Box, { className: this.props.classes.fullWidth },
            this.props.schema.label ? (React.createElement(Typography, { gutterBottom: true }, this.getText(this.props.schema.label))) : null,
            React.createElement(Slider, { className: this.props.classes.slider, value: this.state._value, getAriaValueText: value => value + unit, step: this.props.schema.step || (max - min) / 100, valueLabelDisplay: "auto", marks: marks, min: min, max: max, disabled: !!disabled, error: error || '', onChange: e => {
