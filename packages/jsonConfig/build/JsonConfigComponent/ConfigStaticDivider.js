...
class ConfigStaticDivider extends ConfigGeneric {
    renderItem() {
        return React.createElement("hr", { className: Utils.clsx(this.props.classes.fullWidth, this.props.schema.color === 'primary' && this.props.classes.primary, this.props.schema.color === 'secondary' && this.props.classes.secondary), style: {
