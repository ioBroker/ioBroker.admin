        ...
        return React.createElement(Dialog, { maxWidth: "lg", open: !0, onClose: (e, reason) => {
            ...
            React.createElement(DialogContent, null,
                ...
                !this.props.schema.licenseUrl && this.props.schema.texts ? React.createElement("div", { ref: this.scrollRef, style: {
                        width: '100%', height: '100%', overflowY: 'auto', fontSize: 14,
                    } }, this.props.schema.texts.map(text => (this.props.schema.noTranslation ? React.createElement("p", null, text) : React.createElement("p", null, I18n.t(text))))) : null),
            React.createElement(DialogActions, null,
                ...
                React.createElement(Button, { disabled: this.state.loading || this.state.error || (this.props.schema.checkBox && !this.state.licenseChecked) || !this.state.scrolledDown, onClick: () => {
                        this.setState({ showLicenseDialog: null });
                        this.onChange(this.props.attr, true);
                    }, color: "primary", variant: "contained", startIcon: React.createElement(Check, null) }, this.props.schema.agreeText ? I18n.t(this.props.schema.agreeText) : I18n.t('ra_Accept license')),
