    ...
    render() {
        ...
        if (!CustomComponent) {
            ...
            const item = React.createElement(Grid, { item: true, xs: schema.xs || undefined, lg: schema.lg || undefined, md: schema.md || undefined, sm: schema.sm || undefined, style: ({
                ...
                }) }, this.state.error ? React.createElement("div", null, this.state.error) : React.createElement(LinearProgress, null));
            if (schema.newLine) {
        ...
        return React.createElement(CustomComponent, { ...this.props });
    }
}
