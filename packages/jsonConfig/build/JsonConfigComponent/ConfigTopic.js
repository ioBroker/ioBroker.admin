...
class ConfigTopic extends ConfigGeneric {
    ...
    renderItem(error, disabled /* , defaultValue */) {
        return React.createElement(TextField, { variant: "standard", fullWidth: true, inputProps: { maxLength: this.props.schema.maxLength || this.props.schema.max || undefined }, value: this.state.value, error: !!error, disabled: disabled, placeholder: this.getText(this.props.schema.placeholder), label: this.getText(this.props.schema.label), helperText: this.renderHelp(this.props.schema.help, this.props.schema.helpLink, this.props.schema.noTranslation), onChange: e => {
