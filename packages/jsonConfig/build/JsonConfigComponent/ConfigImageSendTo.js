...
class ConfigImageSendTo extends ConfigGeneric {
    ...
    renderItem( /* error, disabled, defaultValue */) {
        ...
        return React.createElement("img", { className: this.props.classes.fullWidth, alt: "dynamic content", src: this.state.image, style: { width: this.props.schema.width, height: this.props.schema.height } });
    }
}
