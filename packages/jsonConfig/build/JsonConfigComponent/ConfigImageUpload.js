...
class ConfigImageUpload extends ConfigGeneric {
    ...
    renderItem(error, disabled /* , defaultValue */) {
        ...
        return React.createElement(FormControl, { className: this.props.classes.fullWidth, variant: "standard" },
            ...
            React.createElement(UploadImage, { error: !!error, disabled: disabled, accept: this.props.schema.accept, crop: this.props.schema.crop, maxSize: this.props.schema.maxSize || 256 * 1024, icon: this.state.value || undefined, removeIconFunc: () => {
                    if (this.props.schema.base64) {
                        this.setState({ value: null }, () => this.onChange(this.props.attr, this.state.value));
                    }
                    else {
                    ...
                    if (this.props.schema.base64) {
                        this.setState({ value: base64 }, () => this.onChange(this.props.attr, this.state.value));
                    }
                    else {
            ...
            this.props.schema.base64 ? null : React.createElement("img", { src: this._getUrl(), ref: this.imageRef, className: this.props.classes.image, style: { display: 'none' }, alt: "Background" }));
    }
}
