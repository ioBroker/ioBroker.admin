...
class ConfigCoordinates extends ConfigGeneric {
    ...
    renderItem(error, disabled /* , defaultValue */) {
        return React.createElement(React.Fragment, null,
            this.props.schema.useSystemName ? React.createElement(FormControlLabel, { control: React.createElement(Checkbox, { checked: !!this.state.useSystem, onChange: e => {
            ...
            this.props.schema.longitudeName && this.props.schema.latitudeName ?
                React.createElement(TextField, { variant: "standard", className: this.props.classes.width50, value: this.state.longitude ?? '', error: !!error, disabled: this.state.useSystem || !!disabled, onChange: e => {
            ...
            this.props.schema.longitudeName && this.props.schema.latitudeName ?
                React.createElement(TextField, { variant: "standard", className: this.props.classes.width50, value: this.state.latitude ?? '', error: !!error, disabled: this.state.useSystem || !!disabled, onChange: e => {
                        const latitude = e.target.value;
                        this.setState({ latitude }, () => this.onChange(this.props.schema.latitudeName, (latitude || '').trim()));
                    }, label: I18n.t('ra_Latitude') }) : null,
            !this.props.schema.longitudeName || !this.props.schema.latitudeName ?
                React.createElement(TextField, { variant: "standard", className: this.props.classes.width, value: this.state.value === null || this.state.value === undefined ? '' : this.state.value, error: !!error, readOnly: this.state.useSystem, disabled: !!disabled, inputProps: { maxLength: this.props.schema.maxLength || this.props.schema.max || undefined }, onChange: e => {
