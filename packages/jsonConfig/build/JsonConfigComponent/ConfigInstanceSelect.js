...
class ConfigInstanceSelect extends ConfigGeneric {
    ...
    renderItem(error, disabled /* , defaultValue */) {
        ...
        return React.createElement(FormControl, { className: this.props.classes.fullWidth, key: this.props.attr, variant: "standard" },
            ...
            React.createElement(Select, { variant: "standard", error: !!error, displayEmpty: true, disabled: !!disabled, value: this.state.value, renderValue: () => React.createElement("span", { style: { display: 'flex' } },
                    item?.icon ? React.createElement("img", { src: `./${item.icon}`, alt: item.value, className: this.props.classes.icon }) : null,
                ...
                it.icon ? React.createElement("img", { src: `./${it.icon}`, alt: it.value, className: this.props.classes.icon }) : null,
