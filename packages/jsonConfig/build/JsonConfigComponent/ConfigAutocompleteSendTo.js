...
class ConfigAutocompleteSendTo extends ConfigGeneric {
    ...
    renderItem(error, disabled) {
        ...
        if (!options.length) {
            return React.createElement(TextField, { variant: "standard", fullWidth: true, value: this.state.value === null || this.state.value === undefined ? '' : this.state.value, error: !!error, disabled: disabled, inputProps: { maxLength: this.props.schema.maxLength || this.props.schema.max || undefined }, onChange: e => {
        ...
        return React.createElement(Autocomplete, { value: item, fullWidth: true, freeSolo: !!this.props.schema.freeSolo, options: options, 
            // autoComplete
            getOptionLabel: option => option?.label ?? '', className: this.props.classes.indeterminate, onInputChange: e => {
