...
class ConfigColor extends ConfigGeneric {
    renderColorDialog() {
        return !!this.state.showColorDialog && React.createElement(Dialog, { onClose: () => this.setState({ showColorDialog: false }), open: this.state.showColorDialog },
            React.createElement(ChromePicker, { color: this.state.colorDialogValue, onChange: value => this.setState({ colorDialogValue: value }, () => this.onChange(this.props.attr, ColorPicker.getColor(this.state.colorDialogValue, true))) }));
    }
    renderItem(error, disabled /* , defaultValue */) {
        ...
        return React.createElement(React.Fragment, null,
            ...
            React.createElement(TextField, { variant: "standard", disabled: !!disabled, style: { minWidth: 100, width: 'calc(100% - 8px)' }, label: this.getText(this.props.schema.label), value: value || '', onClick: () => !this.props.schema.readOnly && this.setState({ showColorDialog: true, colorDialogValue: value || '' }), onChange: e => {
                ...
                InputProps: {
                    endAdornment: value ?
                        React.createElement(IconButton, { disabled: !!this.props.onPaste, size: "small", onClick: e => {
                                e.stopPropagation();
