...
class ConfigNumber extends ConfigGeneric {
    ...
    renderItem(error, disabled) {
        ...
        if (isIndeterminate) {
            ...
            return React.createElement(Autocomplete, { className: this.props.classes.indeterminate, fullWidth: true, value: arr[0], 
                // @ts-expect-error needs investigation if this really has no effect
                getOptionSelected: (option, value) => option.label === value.label, onChange: (_, value) => this.onChange(this.props.attr, value?.value), options: arr, getOptionLabel: option => option.label, renderInput: params => (React.createElement(TextField, { variant: "standard", ...params, inputProps: { readOnly: this.props.schema.readOnly || false }, error: !!error, placeholder: this.getText(this.props.schema.placeholder), label: this.getText(this.props.schema.label), helperText: this.renderHelp(this.props.schema.help, this.props.schema.helpLink, this.props.schema.noTranslation), disabled: !!disabled })) });
        }
        ...
        return React.createElement(FormControl, { variant: "standard", className: this.props.classes.control },
            React.createElement(TextField, { variant: "standard", type: "number", fullWidth: true, inputProps: {
