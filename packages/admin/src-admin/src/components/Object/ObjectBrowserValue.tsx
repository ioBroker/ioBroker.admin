...
class ObjectBrowserValue extends Component<ObjectBrowserValueProps, ObjectBrowserValueState> {
    ...
    renderTimePicker(): React.JSX.Element {
        return (
            <LocalizationProvider adapterLocale={localeMap[this.props.lang]} dateAdapter={AdapterDateFns}>
                <DatePicker
        ...
        if (
            ...
            return (
                <Autocomplete
                    ...
                    renderInput={params => <TextField {...params} label={this.props.t('Value')} variant="standard" />}
                />
            );
        }
        return (
        ...
        return (
            ...
            >
                ...
                <DialogContent>
                    ...
                    >
                        <Grid2 container direction="row" spacing={2} style={{ height: '100%' }}>
                            <Grid2
                                component="div"
                                size={{ xs: this.state.chart && this.state.chartEnabled ? 6 : 12 }}
                                style={{ height: '100%' }}
                            >
                                <Grid2 container direction="column" spacing={2} style={{ marginTop: 0, height: '100%' }}>
                                    {this.props.expertMode ? (
                                        <Grid2>
                                            <Grid2 container direction="row" spacing={2} style={{ marginTop: 0 }}>
                                                {this.props.expertMode ? (
                                                    <Grid2>
                                    ...
                                    this.state.type === 'number' ? (
                                        <Grid2 style={{ display: 'flex', gap: '5px' }} size={{ xs: 6 }}>
