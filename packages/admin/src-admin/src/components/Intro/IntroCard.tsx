            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <CardMedia style={styles.img} component="img" image={this.props.image}></CardMedia>
                            <div
                                style={{
                                    flex: 1,
                                    display: 'flex',
                            ...
                            >
                                {this.props.warning ? (
                                    <Tooltip title={this.props.warning} slotProps={{ popper: { sx: styles.tooltip } }}>
                                        <WarningIcon
                                            style={{
                                                alignSelf: 'end',
                                                fontSize: 36,
                        ...
                        <div style={{ ...styles.contentContainer, ...editClass }}>
                            <CardContent style={styles.content}>
                                <Grid2 container direction="column" wrap="nowrap" style={styles.contentGrid}>
                        ...
                        {this.props.showInfo && (
                            <Collapse style={styles.collapse} in={this.state.expanded} timeout="auto" unmountOnExit>
