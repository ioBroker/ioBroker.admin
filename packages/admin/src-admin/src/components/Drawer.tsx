...
v
    ...
    badge = (tab: AdminTab): {
        ...
        switch (tab.name) {
            ...
            case 'tab-hosts':
                return {
                    content: this.state.hostsUpdate || 0, color: 'primary', additionalContent: this.state.hostNotifications.warning + this.state.hostNotifications.other, additionalColor: this.state.hostNotifications.warning > 0 ? 'error' : 'secondary',
                };
