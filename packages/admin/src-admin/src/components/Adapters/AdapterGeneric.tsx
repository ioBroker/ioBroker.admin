...
> extends AdapterInstallDialog<TProps, TState> {
        ...
        return (
            <IsVisible value={allowAdapterReadme}>
                <Tooltip title={this.props.context.t('Readme')} slotProps={{ popper: { sx: this.styles.tooltip } }}>
                    <IconButton size="small" onClick={() => this.openInfoDialog()}>
                        <HelpIcon />
                    </IconButton>
                </Tooltip>
            </IsVisible>
    ...
    renderLicenseInfo() {
        ...
        return (
            <Link href={link} target="_blank" rel="noopener" sx={{ color: 'black', '&:hover': { color: 'black' } }}>
        ...
        return sentry ? (
            <div style={this.styles.marginLeft5}>
                <Tooltip title="sentry" slotProps={{ popper: { sx: this.styles.tooltip } }}>
                    <CardMedia style={this.styles.sentry} component="img" image={sentryIcon} />
                </Tooltip>
            </div>
        ) : null;
    }
    ...
    renderVersion() {
        ...
        return !this.props.commandRunning && this.props.cached.updateAvailable && allowAdapterUpdate !== false ? (
            <Tooltip title={this.props.context.t('Update')} slotProps={{ popper: { sx: this.styles.tooltip } }}>
                <div
                ...
                >
                    <IconButton style={this.styles.buttonUpdateIcon} size="small">
                        <RefreshIcon />
                    </IconButton>
    ...
    renderInstalledVersion(isRow?: boolean) {
        ...
        if (isRow) {
            ...
            return (
                <Grid2 container wrap="nowrap" alignItems="center" spacing={1}>
                    ...
                    {installedFrom && !installedFrom.startsWith(`iobroker.${adapterName}@`) && (
                        <Grid2 container>
                            <Tooltip
                                ...
                                slotProps={{ popper: { sx: this.styles.tooltip } }}
                            >
                                <GitHubIcon fontSize="small" style={this.styles.versionWarn} />
                            </Tooltip>
                        </Grid2>
                    )}
                </Grid2>
    ...
    renderUploadButton() {
        return (
            ...
            this.installedVersion && (
                <Tooltip title={this.props.context.t('Upload')} slotProps={{ popper: { sx: this.styles.tooltip } }}>
                    <IconButton size="small" disabled={this.props.commandRunning} onClick={() => this.onUpload()}>
                        <PublishIcon />
                    </IconButton>
                </Tooltip>
            )
    ...
    renderRebuildButton() {
        ...
        return (
            <Tooltip title={this.props.context.t('Rebuild')}>
                <IconButton size="small" disabled={this.props.commandRunning} onClick={() => this.rebuild()}>
                    <BuildIcon />
                </IconButton>
            </Tooltip>
        );
        ...
        return (
            ...
            >
                <div style={{ height: '100%', overflowY: 'hidden' }}>
                    ...
                    <Box component="div" sx={this.styles.header}>
