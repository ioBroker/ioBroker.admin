...
class AdaptersUpdater extends Component<AdaptersUpdaterProps, AdaptersUpdaterState> {
        ...
        return (
            ...
            >
                <ListItemIcon sx={styles.minWidthCss}>
                    <Avatar variant="square" alt={adapter} src={image} style={styles.smallAvatar} />
                </ListItemIcon>
                <ListItemText
                    primary={adapter}
                    ...
                    secondary={
                        <span>
                            <div style={styles.versions}>
                                ...
                                <Box component="span" sx={styles.toVersion}>
                                    {this.props.repository[adapter].version}
                                </Box>
                            </div>
                            <IconButton
                        ...
                        result.push(
                            <Grid2 key={version}>
                                ...
                                {news.map((value, index) => (
                                    <Typography key={`${version}-${index}`} component="div" variant="body2">
                                        {`• ${value}`}
                                    </Typography>
                                ))}
                            </Grid2>
    ...
    renderShowNews() {
        if (this.state.showNews) {
            ...
            return (
                <Dialog onClose={() => this.setState({ showNews: null })} open={!0}>
                    <DialogTitle>
                    ...
                    <DialogContent dividers>
                        <Grid2 container direction="column" spacing={2} wrap="nowrap">
                            {news.length ? (
                                <Grid2>
                                    <Typography variant="h6" gutterBottom>
                                        {I18n.t('Change log')}
                                    </Typography>
                                    <Grid2 container spacing={2} direction="column" wrap="nowrap">
                                        {news}
                                    </Grid2>
                                </Grid2>
                            ) : (
