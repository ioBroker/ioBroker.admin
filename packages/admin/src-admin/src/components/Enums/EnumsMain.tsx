...
class EnumsList extends Component<EnumsListProps, EnumsListState> {
    ...
    async componentWillUnmount() {
        await this.props.socket.unsubscribeObject('enum.*', this.onObjectChange);
    ...
    renderTree(container: TreeItem, key: number, level: number) {
            ...
            if (pos !== -1) {
                nameRx = name
                    ? [
                          ...
                          <span key="1" style={styles.searchText}>
        ...
        return (
            <div style={{ paddingLeft: level ? 32 : 0 }} key={container.id || key}>
                <EnumBlock
            ...
            <>
                <DndProvider backend={isTouchDevice() ? TouchBackend : HTML5Backend}>
                    ...
                    <ReactSplit
                        ...
                        minWidths={[450, 450]}
                        onResizeFinished={(_gutterIdx: number, splitSizes: [number, number]) => {
                        ...
                        >
                            <div style={styles.topPanel}>
                                ...
                                <Tabs
                                    ...
                                    variant="scrollable"
                                    scrollButtons="auto"
                                    onChange={(_e, newTab) => this.setCurrentCategory(newTab)}
                                >
