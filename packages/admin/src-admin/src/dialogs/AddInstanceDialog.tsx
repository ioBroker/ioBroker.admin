...
class AddInstanceDialog extends Component<AddInstanceDialogProps, AddInstanceDialogState> {
    ...
    renderMessages() {
        if (this.messages) {
            return (
                <Grid2 container spacing={2} direction="column" wrap="nowrap" sx={{ marginBottom: 1 }}>
    ...
    render() {
        ...
        return (
            <Dialog onClose={() => {}} open={!0} sx={{ '& .MuiDialog-paper': styles.paper }}>
                <DialogTitle>
                    <Typography component="h2" variant="h6" sx={{ '&.MuiTypography-root': styles.typography }}>
                        ...
                        <IconButton size="large" sx={styles.closeButton} onClick={() => this.props.onClose(false)}>
                            <CloseIcon />
                        </IconButton>
