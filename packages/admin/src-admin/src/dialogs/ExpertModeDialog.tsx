                    ...
                    <Grid2 style={styles.width100}>
                        <Box component="div" sx={styles.root}>
                            <div style={styles.pre}>
                                <Typography style={styles.text} variant="body2" component="p">
                                    {expertMode
                                        ? I18n.t(
                                ...
                                {!expertMode ? (
                                    <Typography style={styles.textBold} variant="body2" component="p">
                                ...
                                <IconButton color="primary" size="small" onClick={() => onClose('openSettings')}>
                                    <BuildIcon />
                                </IconButton>
                            </div>
                        </Box>
