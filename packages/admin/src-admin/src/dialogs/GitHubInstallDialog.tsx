...
class GitHubInstallDialog extends React.Component<GitHubInstallDialogProps, GitHubInstallDialogState> {
    ...
    renderNpm() {
        return this.state.currentTab === 'npm' ? (
            <Paper style={styles.tabPaper} id="github-install-dialog-panel-npm">
                ...
                <div style={{ display: 'flex', alignItems: 'flex-end' }}>
                    ...
                    <Autocomplete
                        ...
                        renderInput={params => {
                            ...
                            return <TextField variant="standard" {...params} label={I18n.t('Select adapter')} />;
                        }}
    ...
    renderGitHub() {
        return this.state.currentTab === 'GitHub' ? (
            <Paper style={styles.tabPaper} id="github-install-dialog-panel-github">
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <FormControlLabel
                        control={
                            <Checkbox
    ...
    renderCustom() {
        return this.state.currentTab === 'URL' ? (
            <Paper style={styles.tabPaper} id="github-install-dialog-panel-custom">
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <FormControlLabel
                        control={
                            <Checkbox
                            ...
                            input: {
                                endAdornment: this.state.url ? (
                                    <InputAdornment position="end">
                                        <IconButton size="small" onClick={() => this.setState({ url: '' })}>
                                            <CloseIcon />
                                        </IconButton>
                                    </InputAdornment>
                                ) : null,
    ...
    render(): React.JSX.Element {
        ...
        return (
            <Dialog onClose={() => this.props.onClose()} open={!0} sx={{ '& .MuiDialog-paper': styles.paper }}>
