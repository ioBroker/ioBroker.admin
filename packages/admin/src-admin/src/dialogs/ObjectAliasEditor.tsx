...
class ObjectAliasEditor extends Component<ObjectAliasEditorProps, ObjectAliasEditorState> {
    ...
    renderAddNewAlias() {
        ...
        return (
            <Dialog open={!0} onClose={() => this.setState({ showAddNewAlias: false })}>
                            ...
                            input: {
                                endAdornment: this.state.newAliasId ? (
                                    <InputAdornment position="end">
                                        <IconButton size="small" onClick={() => this.setState({ newAliasId: '' })}>
                                            <IconClose />
                                        </IconButton>
                                    </InputAdornment>
                                ) : null,
                        ...
                        slotProps={{
                            input: {
                                endAdornment: this.state.newAliasName ? (
                                    <InputAdornment position="end">
                                        <IconButton size="small" onClick={() => this.setState({ newAliasName: '' })}>
                                            <IconClose />
                                        </IconButton>
                                    </InputAdornment>
                                ) : null,
                        ...
                        slotProps={{
                            input: {
                                endAdornment: this.state.newAliasDesc ? (
                                    <InputAdornment position="end">
                                        <IconButton size="small" onClick={() => this.setState({ newAliasDesc: '' })}>
                                            <IconClose />
                                        </IconButton>
                                    </InputAdornment>
                                ) : null,
                        ...
                        slotProps={{
                            input: {
                                endAdornment: this.state.newAliasUnit ? (
                                    <InputAdornment position="end">
                                        <IconButton size="small" onClick={() => this.setState({ newAliasUnit: '' })}>
                                            <IconClose />
                                        </IconButton>
                                    </InputAdornment>
                                ) : null,
            ...
            >
                ...
                <DialogContent>
                    <MenuList style={{ maxWidth: 400 }}>
                        ...
                        <MenuItem onClick={() => this.setState({ showAddNewAlias: true })} sx={styles.addNewAlias}>
                            <ListItemIcon>
