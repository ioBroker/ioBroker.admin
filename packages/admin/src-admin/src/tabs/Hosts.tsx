        ...
        return (
            <div style={styles.tabHeaderWrapper}>
                ...
                <div style={styles.tabFlex}>
                    ...
                    <Box component="div" sx={Utils.getStyle(this.props.theme, styles.tabHeaderItem, styles.hidden800)}>
                        CPU
                    </Box>
                    <Box component="div" sx={Utils.getStyle(this.props.theme, styles.tabHeaderItem, styles.hidden800)}>
                        RAM
                    ...
                    <Box component="div" sx={Utils.getStyle(this.props.theme, styles.tabHeaderItem, styles.hidden600)}>
                        {this.t('Events')}
                    </Box>
                    <div
                        style={{
            ...
            <TabContainer>
                ...
                <TabContent overflow="auto">
                    {!Utils.isStableRepository(this.props.systemConfig.common.activeRepo) ? (
                        <Box component="div" sx={styles.notStableRepo}>
